...
namespace TP_02_2018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Nombre del alumno
            Console.Title = "Consola de Matias Herrera";
            ...
            Leche m2 = new Leche(Producto.EMarca.Serenisima, "IOP852", ConsoleColor.Blue, Leche.ETipoLeche.Descremada);
            ...
            // Muestro solo Dulces
            Console.WriteLine(changoDeCompras.Mostrar(changoDeCompras, Changuito.ETipoProducto.Leche));
            Console.WriteLine("<-----------PRESIONE UNA TECLA PARA CONTINUAR----------->");
            Console.ReadKey();
            Console.Clear();

            // Muestro solo Leches
            Console.WriteLine(changoDeCompras.Mostrar(changoDeCompras, Changuito.ETipoProducto.Dulce));
            Console.WriteLine("<-----------PRESIONE UNA TECLA PARA CONTINUAR----------->");
            Console.ReadKey();
            Console.Clear();

            // Muestro solo Snacks
            Console.WriteLine(changoDeCompras.Mostrar(changoDeCompras, Changuito.ETipoProducto.Snacks));
